...
function reset() {
  ...
  entries1 = ["Proper Noun (Person's Name)","Noun","Adjective (Feeling)","Verb","Adjective (Feeling)","Animal","Verb","Color","Verb (ending in ing)","Adverb (ending in ly)","Number","Measure of Time","Color","Animal","Number","Silly Word","Noun"];
  entries2 = ["Number", "Measure of time", "Mode of Transportation", "Adjective", "Adjective", "Noun", "Color", "Part of the Body", "Verb", "Number", "Noun", "Noun", "Part of the Body", "Verb", "Noun", "Adjective", "Silly Word", "Noun"];
  entries3 = ["Proper Noun (Person’s Name)", "Adjective", "Color", "Animal", "Place", "Adjective", "Magical Creature (Plural)", "Adjective", "Magical Creature (Plural)", "Room in a House", "Noun", "Noun", "Noun", "Adjective", "Noun (Plural)", "Number", "Measure of time", "Verb (ending in ing)", "Adjective", "Noun"];
